...
void main()
{
    ...
    f_out.open("CTR_out1.bmp", ios::out|ios::binary);
    ...
    file.open("CTR_out1.bmp", ios::in|ios::binary);
    f_out.open("CTR_out2.bmp", ios::out|ios::binary);
